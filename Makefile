...
.PHONY: list
list:
	@echo no default target, please specify one of:
...
PLUGINNAME = DistanceMatrixToCoords
...
pep8:
	...
	@echo "PEP8 issues"
	@echo "-----------"
	@-pep8 --repeat --ignore=E203,E121,E122,E123,E124,E125,E126,E127 --exclude $(PEP8EXCLUDE) . || true
	@echo "-----------"
