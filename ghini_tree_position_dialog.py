...
DISTANCES_FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'ghini_tree_position_dialog_base.ui'))


class DistanceMatrixToCoordsDialog(QtGui.QDialog, DISTANCES_FORM_CLASS):
...
ADJUSTER_FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'ghini_correct_GPS_dialog_base.ui'))


class GpsAndDistancesToAdjustedGpsDialog(QtGui.QDialog, ADJUSTER_FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
